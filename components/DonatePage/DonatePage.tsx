...
export const DonatePage = () => {
  return (
    <section className="relative z-50 h-[1000px] bg-white 2xl:h-screen py-28 xl:pt-20 xl:flex xl:justify-around xl:px-4 bg-gradient-to-br from-sky-400 to-cyan-300 ">
