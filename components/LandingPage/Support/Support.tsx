...
export const Support = () => {
  return (
    <section className="rounded-md flex w-[90vw] h-96 justify-center mx-auto flex-col items-center p-4 m-12 mb-24 bg-gradient-to-r from-[#48cae4] via-[#5e60ce] to-[#57cc99] text-white">
