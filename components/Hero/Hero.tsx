...
export const Hero = () => {
  return (
    <HeroOverlay id="Hero">
      <h2 className="md:hidden px-4 text-3xl w-[300px] leading-10 sm:text-3xl md:w-[700px] mx-auto text-center">
      ...
      <p className="p-8 text-md text-center md:text-xl md:w-[700px] lg:w-[1100px] md:mx-auto my-2 md:leading-8 lg:py-6">
